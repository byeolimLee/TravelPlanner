...
public class TravelItemAccommodationFragment extends Fragment implements Animation.AnimationListener  {
    ...
    public static TravelItemAccommodationFragment newInstance(int x, int y, int width, int height){
        TravelItemAccommodationFragment fragment= new TravelItemAccommodationFragment();
        Bundle args=new Bundle();
        args.putInt(ARG_RESOURCE_ID, R.drawable.p2);
        args.putString(ARG_TITLE, TravelItemCategory.TYPE_STRING_ACCOMMODATION);
        args.putInt(ARG_X,x);
        args.putInt(ARG_Y,y);
