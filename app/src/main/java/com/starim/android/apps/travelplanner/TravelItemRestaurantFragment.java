...
public class TravelItemRestaurantFragment extends Fragment implements Animation.AnimationListener  {

    private static final String TAG = "TravelItemRestaurantFragment";
    ...
    public static TravelItemRestaurantFragment newInstance(int x, int y, int width, int height){
        TravelItemRestaurantFragment fragment= new TravelItemRestaurantFragment();
        Bundle args=new Bundle();
        args.putInt(ARG_RESOURCE_ID, R.drawable.p4);
        args.putString(ARG_TITLE, TravelItemCategory.TYPE_STRING_RESTUARANT);
        args.putInt(ARG_X,x);
        args.putInt(ARG_Y,y);
    ...
    public TravelItemRestaurantFragment() {
    }
