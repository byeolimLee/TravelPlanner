...
public class TravelItemShoppingPlacesFragment extends Fragment implements Animation.AnimationListener  {

    private static final String TAG = "TravelItemShoppingPlacesFragment";
    ...
    public static TravelItemShoppingPlacesFragment newInstance(int x, int y, int width, int height){
        TravelItemShoppingPlacesFragment fragment= new TravelItemShoppingPlacesFragment();
        Bundle args=new Bundle();
        args.putInt(ARG_RESOURCE_ID, R.drawable.p3);
        args.putString(ARG_TITLE, TravelItemCategory.TYPE_STRING_SHOPPINGPLACES);
        args.putInt(ARG_X,x);
        args.putInt(ARG_Y,y);
    ...
    public TravelItemShoppingPlacesFragment() {
    }
